...
public class Exercise_back extends AppCompatActivity implements MyAdapter.MyRecyclerViewClickListener2{
    Context Acontext;
...
//        exerciseInfoArrayList.add(new ExerciseInfo("등","T-Bar Row",R.drawable.ba_tbarrow,false,false));
        ...
        for(int i =0 ; i<exerciseInfoArrayList.size(); i++) {
            ...
            editor.putString("등"+Integer.toString(i),s);
            editor.putString("등사이즈",Integer.toString(exerciseInfoArrayList.size()));
            editor.apply();
        }
        ...
        for(int i =0 ; i<exerciseInfoArrayList.size(); i++) {
            ...
            Gson gson = new Gson();
            String s = gson.toJson(exerciseInfoArrayList.get(i));
            editor2.putString("등"+Integer.toString(i),s);
            editor2.putString("등사이즈",Integer.toString(exerciseInfoArrayList.size()));
            /***/
            editor2.apply();
        }
        /***/
        ...
        if(isAdd){
            ...
            floatingActionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog.Builder mBuilder = new AlertDialog.Builder(Exercise_back.this);
...
//                                           Log.e("??? 추가 버튼 누를때","뭐야 ㅅㅂ");
                            ...
                            Toast.makeText(Exercise_back.this,"운동목록 : ["+Wname+"] 에 선택한 운동이 담겼습니다.",Toast.LENGTH_LONG).show();
    ...
    public void onItemClicked2(int position, View v) {
        ...
        Intent intent = new Intent(Exercise_back.this, How_to_xx.class);
    ...
    public void load2(){
        ...
        String kk = sss.getString("등0","null");
        Log.e("??? load2 등 정보",kk);
        if(kk.equals("null")){
            exerciseInfoArrayList = new ArrayList<>();
            exerciseInfoArrayList.add(new ExerciseInfo("등","Bent Arm Pull-Over",R.drawable.ba_bent_over_row,false,false));
            ...
            String  size = sss2.getString("등사이즈","null");
            Log.e("??? load2 등 사이즈 정보",size);
            for(int i=0; i<Integer.parseInt(size); i++){
                String val = sss2.getString("등"+Integer.toString(i),"null");
                Log.e("??? load2 각각 등 정보"+Integer.toString(i),val);
                try {
                    JSONObject jsonObject = new JSONObject(val);
                    ...
                    Log.e("??? load2 각각 등 정보"+Integer.toString(i),"뭐지 ㅅㅂ???????????");
