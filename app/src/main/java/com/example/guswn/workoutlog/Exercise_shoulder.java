...
public class Exercise_shoulder extends AppCompatActivity implements MyAdapter.MyRecyclerViewClickListener2{
...
//        exerciseInfoArrayList.add(new ExerciseInfo("어깨","Upright Row",R.drawable.s_upright_row,false,false));
        ...
        for(int i =0 ; i<exerciseInfoArrayList.size(); i++) {
            ...
            editor.putString("어깨사이즈",Integer.toString(exerciseInfoArrayList.size()));
            editor.putString("어깨"+Integer.toString(i),s);
            editor.apply();
        }
        ...
        for(int i =0 ; i<exerciseInfoArrayList.size(); i++) {
            ...
            Gson gson = new Gson();
            String s = gson.toJson(exerciseInfoArrayList.get(i));
            editor2.putString("어깨사이즈",Integer.toString(exerciseInfoArrayList.size()));
            editor2.putString("어깨"+Integer.toString(i),s);
            /***/
            editor2.apply();
        }
        /***/
        ...
        if(isAdd){
            ...
            floatingActionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog.Builder mBuilder = new AlertDialog.Builder(Exercise_shoulder.this);
...
//                                           Log.e("??? 추가 버튼 누를때","뭐야 ㅅㅂ");
                            ...
                            Toast.makeText(Exercise_shoulder.this,"운동목록 : ["+Wname+"] 에 선택한 운동이 담겼습니다.",Toast.LENGTH_LONG).show();
    ...
    public void load2(){
        ...
        String kk = sss.getString("어깨0","null");
        Log.e("??? load2 어깨 정보",kk);
        if(kk.equals("null")){
            exerciseInfoArrayList = new ArrayList<>();
            exerciseInfoArrayList.add(new ExerciseInfo("어깨","Arnold Press",R.drawable.s_arnold_press,false,false));
            exerciseInfoArrayList.add(new ExerciseInfo("어깨","Cuban Press",R.drawable.c_cuban_press,false,false));
            ...
            String  size = sss2.getString("어깨사이즈","null");
            Log.e("??? load2 어깨 사이즈 정보",size);
            for(int i=0; i<Integer.parseInt(size); i++){
                String val = sss2.getString("어깨"+Integer.toString(i),"null");
                Log.e("??? load2 각각 어깨 정보"+Integer.toString(i),val);
                try {
                    JSONObject jsonObject = new JSONObject(val);
                    ...
                    Log.e("??? load2 각각 어깨 정보"+Integer.toString(i),"뭐지 ㅅㅂ???????????");
    ...
    public void onItemClicked2(int position, View v) {
        ...
        Intent intent = new Intent(Exercise_shoulder.this, How_to_xx.class);
