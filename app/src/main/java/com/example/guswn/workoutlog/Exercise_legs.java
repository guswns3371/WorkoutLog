...
public class Exercise_legs extends AppCompatActivity  implements MyAdapter.MyRecyclerViewClickListener2{
    Context Acontext;
...
//            exerciseInfoArrayList.add(new ExerciseInfo("하체","Step Up (Dumbbell)", R.drawable.l_step_up_dumbbell, false,false));
        ...
        for(int i =0 ; i<exerciseInfoArrayList.size(); i++) {
            ...
            editor.putString("하체사이즈",Integer.toString(exerciseInfoArrayList.size()));
            editor.putString("하체"+Integer.toString(i),s);
            editor.apply();
        }
        ...
        for(int i =0 ; i<exerciseInfoArrayList.size(); i++) {
            ...
            Gson gson = new Gson();
            String s = gson.toJson(exerciseInfoArrayList.get(i));
            editor2.putString("하체사이즈",Integer.toString(exerciseInfoArrayList.size()));
            editor2.putString("하체"+Integer.toString(i),s);
            /***/
            editor2.apply();
        }
        /***/
        ...
        if(isAdd){
            ...
            floatingActionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog.Builder mBuilder = new AlertDialog.Builder(Exercise_legs.this);
...
//                                           Log.e("??? 추가 버튼 누를때","뭐야 ㅅㅂ");
                            ...
                            Toast.makeText(Exercise_legs.this,"운동목록 : ["+Wname+"] 에 선택한 운동이 담겼습니다.",Toast.LENGTH_LONG).show();
    ...
    public void load2(){
        ...
        String kk = sss.getString("하체0","null");
        Log.e("??? load2 하체 정보",kk);
        if(kk.equals("null")){
            exerciseInfoArrayList = new ArrayList<>();
            ...
            String  size = sss2.getString("하체사이즈","null");
            Log.e("??? load2 하체 사이즈 정보",size);
            for(int i=0; i<Integer.parseInt(size); i++){
                String val = sss2.getString("하체"+Integer.toString(i),"null");
                Log.e("??? load2 각각 하체 정보"+Integer.toString(i),val);
                try {
                    JSONObject jsonObject = new JSONObject(val);
                    ...
                    Log.e("??? load2 각각 하체 정보"+Integer.toString(i),"뭐지 ㅅㅂ???????????");
    ...
    public void onItemClicked2(int position, View v) {
        ...
        Intent intent = new Intent(Exercise_legs.this, How_to_xx.class);
